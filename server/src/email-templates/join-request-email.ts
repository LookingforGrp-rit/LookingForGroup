      ...
      createElement(
        ...
        createElement(
          ...
          createElement(
            Text,
            null,
            'Click below to view the request and choose whether to accept or decline.',
          ),
          createElement(
            Section,
            null,
          ...
          createElement(
            ...
            createElement(
              Link,
              { href: joinLink, className: 'text-blue-600 no-underline' },
              joinLink,
            ),
          ),
          createElement(Hr, {
